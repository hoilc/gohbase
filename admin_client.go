...
type AdminClient interface {
	...
	ListTableDescriptors(t *hrpc.ListTableDescriptors) ([]*pb.TableSchema, error)
...
func (c *client) ListTableDescriptors(t *hrpc.ListTableDescriptors) ([]*pb.TableSchema, error) {
	pbmsg, err := c.SendRPC(t)
	if err != nil {
		return nil, err
	}
